        ...
        <div className='form-question mt-4 grid'>
          <div className='btn-wrap grid grid-cols-2 gap-8'>
            ...
            <button
                ...
                className='col-span-2 w-[159px] h-[39px] mx-auto px-[37px] py-2.5 bg-orange-100 rounded-[3px] border border-stone-400 justify-center items-center gap-2.5 inline-flex'
            >
