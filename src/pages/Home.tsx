...
const Home = () => {
	return  (
		<div className='max-w-[780px] w-full mx-auto main'>
			<div className='absolute max-w-[780px] w-full h-full pattern pointer-events-none z-[98]'>
				<div className='splash-1 pointer-events-none'></div>
				<div className='splash-2 pointer-events-none'></div>
			</div>
			<div className='z-[99] relative px-[40px] pt-8 pb-0'>
				<img
			...
			<div className='z-[99] relative px-[50px] py-8'>
			...
			<div className='z-[99] relative px-[70px] pt-0'>
			...
			<div className='bg-[#fff8f2] py-14 px-8 relative'>
				<div className='rsvp rounded-[10px] shadow p-6 z-[100] relative'>
